...
$result=MYSQL_QUERY("INSERT INTO malls_1 (mall_name,city,cust_id,display_name,category) VALUES ('$mall','$city','$cust_id','$customer_display_name','$category')");
...
<h1>Add customers to Malls</h1>
<form id="form1" method="post" action="admin_mall.php">
  <table width="100%">
    <tr>
      <td width="29%">City</td>
...
?>
    ...
    <tr>
      ...
      <td><select name="category" id="category">
        ...
        <option value="hnb">Health &amp; Beauty</option>
      </select>      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
