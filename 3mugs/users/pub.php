...
<div id="wrap">
  ...
  <!-- menu -->	
		<div  id="menu">
			<ul>
	     <?php require_once ("../includes/user_menu.php"); display_menu("pub"); ?>
...
var url = "subscription.php?cat=pub&action=add&username="+user_id+"&sub_id="+sub_id;
GDownloadUrl(url, function(data) {document.getElementById(sub_id).value="Done!"; });
}}
</script>
...
//For Customer campaign in Pub from pub_1 and campaign table
$result=MYSQL_QUERY("SELECT shopname,pub_1.id,title,msg1 FROM campaign,pub_1 WHERE  campaign.cust_id=pub_1.cust_id AND campaign.city='$sql_city';");
...
?>
          <h1>Pubs in <?php echo $_SESSION['city']; ?></h1>
 ...
 ?>
	  ...
	  <p>		   
		 ...
		 $inter_result = MYSQL_QUERY("SELECT * FROM pub_2 WHERE  sub_id='$sub_id' AND user_id='$sql_user_id'");
